...
<div class="row">
    <div class="col-12">
        <?= form_open('master/kamar/update/' . $kamar->id) ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input([
                                ...
                                'value' => old('jml_max', $kamar->jml_max),
                                'min' => '1'
                            ]) ?>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-plaintext"><?= esc($kamar->jml) ?></p>
                            <small class="text-muted">* Jumlah terisi tidak dapat diubah manual</small>
                        </div>
                    </div>
                </div>
            </div>
