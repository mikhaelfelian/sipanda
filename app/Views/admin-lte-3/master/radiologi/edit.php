...
<div class="row">
    <div class="col-5">
        <?= form_open('master/radiologi/update/' . $radiologi->id) ?>
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">Form Edit Radiologi</h3>
            </div>
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori"
                                ...
                                <?php foreach ($kategoris as $kategori): ?>
                                    <option value="<?= $kategori->id ?>" <?= old('kategori', $radiologi->id_kategori) == $kategori->id ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="merk"
                                ...
                                <?php foreach ($merks as $merk): ?>
                                    <option value="<?= $merk->id ?>" <?= old('id_merk', $radiologi->id_merk) == $merk->id ? 'selected' : '' ?>>
                                        <?= esc($merk->merk) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="form-group">
                    <label>Nama Radiologi <span class="text-danger">*</span></label>
                    <?= form_input([
                        'type' => 'text',
                        'name' => 'item',
                        'class' => 'form-control rounded-0 ' . (validation_show_error('item') ? 'is-invalid' : ''),
                        'placeholder' => 'Masukkan nama radiologi',
                        'value' => old('item', $radiologi->item)
                    ]) ?>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <?= form_textarea([
                        ...
                        'placeholder' => 'Masukkan keterangan radiologi',
                        'value' => old('item_kand', $radiologi->item_kand),
                        'rows' => 3
                    ]) ?>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select name="satuan"
                        ...
                        <?php foreach ($satuans as $satuan): ?>
                            <option value="<?= $satuan->id ?>" <?= old('satuan', $radiologi->id_satuan) == $satuan->id ? 'selected' : '' ?>>
                                <?= $satuan->satuanBesar ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?= form_input([
                                    ...
                                    'value' => old('harga_beli', $radiologi->harga_beli)
                                ]) ?>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?= form_input([
                                    ...
                                    'value' => old('harga_jual', $radiologi->harga_jual)
                                ]) ?>
                                <div class="invalid-feedback">
            ...
            <div class="card-footer float-left">
                <a href="<?= base_url('master/radiologi') ?>" class="btn btn-default rounded-0">
