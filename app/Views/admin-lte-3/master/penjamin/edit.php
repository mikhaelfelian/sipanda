...
<div class="row">
    <div class="col-12">
        <?= form_open('master/penjamin/update/' . $penjamin->id) ?>
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">Form Edit Penjamin</h3>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <?= form_input([
                        ...
                        'value' => old('penjamin', $penjamin->penjamin)
                    ]) ?>
                ...
                <div class="form-group">
                    ...
                    <?= form_input([
                        ...
                        'value' => old('persen', $penjamin->persen),
                        'min' => '0',
                        'max' => '100',
                        'step' => '0.01'
                    ]) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="1"
                            id="statusAktif" <?= old('status', $penjamin->status) == '1' ? 'checked' : '' ?>>
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="0"
                            id="statusNonaktif" <?= old('status', $penjamin->status) == '0' ? 'checked' : '' ?>>
