...
<div class="row">
    <div class="col-5">
        <?= form_open('master/tindakan/update/' . $tindakan->id) ?>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori"
                        ...
                        <?php foreach ($kategoris as $kategori): ?>
                            <option value="<?= $kategori->id ?>" <?= old('kategori', $tindakan->id_kategori) == $kategori->id ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <?= form_textarea([
                        ...
                        'value' => old('item_kand', $tindakan->item_kand),
                        'rows' => 3
                    ]) ?>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <?= form_input([
                            ...
                            'value' => old('harga_jual', $tindakan->harga_jual)
                        ]) ?>
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="1" id="statusAktif"
                            <?= old('status', $tindakan->status) == '1' ? 'checked' : '' ?>>
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="0" id="statusNonaktif"
                            <?= old('status', $tindakan->status) == '0' ? 'checked' : '' ?>>
    ...
    <div class="col-7">
        <div class="card rounded-0">
            ...
            <div class="card-body">
                <?= form_open('master/tindakan/item_ref_save/' . $tindakan->id, ['id' => 'formItemRef']) ?>
                <?= form_input([
                    'type' => 'hidden',
                    'id' => 'id_item_ref',
                    'name' => 'id_item_ref'
                                ...
                                foreach ($item_refs as $ref): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('master/tindakan/item_ref_delete/' . $ref->id) ?>"
