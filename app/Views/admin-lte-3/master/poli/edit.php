...
<div class="row">
    <div class="col-12">
        <?= form_open('master/poli/update/' . $poli->id) ?>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <?= form_input([
                        ...
                        'value' => old('post_location', $poli->post_location)
                    ]) ?>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="1"
                            id="statusAktif" <?= old('status', $poli->status) == '1' ? 'checked' : '' ?>>
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="0"
                            id="statusNonaktif" <?= old('status', $poli->status) == '0' ? 'checked' : '' ?>>
