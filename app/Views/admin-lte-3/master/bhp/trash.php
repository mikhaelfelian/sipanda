    ...
    <div class="col-12">
        <div class="card rounded-0">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <a href="<?= base_url('master/bhp') ?>" class="btn btn-sm btn-primary rounded-0">
            ...
            <div class="card-body table-responsive">
                <?= form_open(base_url('master/bhp/trash'), ['method' => 'get']) ?>
                    ...
                    <tbody>
                        <?php foreach ($bhp as $key => $row): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= base_url("master/bhp/restore/$row->id") ?>"
                                            class="btn btn-success btn-sm rounded-0"
                                            onclick="return confirm('Pulihkan data ini?')">
                                            <i class="fas fa-undo"></i>
                                        </a>
                                        <a href="<?= base_url("master/bhp/delete_permanent/$row->id") ?>"
