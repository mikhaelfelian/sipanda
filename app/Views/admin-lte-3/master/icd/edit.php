...
<div class="row">
    <div class="col-12">
        <?= form_open('master/icd/update/' . $icd->id) ?>
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">Form Edit ICD</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_textarea([
                                ...
                                'value' => old('diagnosa_en', $icd->diagnosa_en)
                            ]) ?>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_textarea([
                                ...
                                'value' => old('diagnosa_id', $icd->diagnosa_id)
                            ]) ?>
                            <div class="invalid-feedback">
